...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    public void chooseImage() {
        // TODO-C2 (4) Start Activity to select a image
    ...
    private void postVideo() {
        ...
        //
        Call<PostVideoResponse> call = req.postvideo("16061027","aico", part1, part2);
        //System.out.println("test");
        call.enqueue(new Callback<PostVideoResponse>() {
            @Override
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                Toast.makeText(Solution2C2Activity.this, "success to post!", Toast.LENGTH_SHORT).show();
                System.out.println("success");
            }

            @Override
            public void onFailure(Call<PostVideoResponse> call, Throwable t) {
                Toast.makeText(Solution2C2Activity.this, "fail to post!", Toast.LENGTH_SHORT).show();
    ...
    public void fetchFeed(View view) {
        ...
        IMiniDouyinService frequest = retrofit2.create(IMiniDouyinService.class);
        Call<FeedResponse> call2 = frequest.getfeed();

        call2.enqueue(new Callback<FeedResponse>() {
            @Override
